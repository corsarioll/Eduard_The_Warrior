...
class TabPaint(BaseTab):
    ...
    def licenseStatusChanged(self):
        ...
        licenseActive = license.licenseStatus()==0
        self.controls.mirroredMode.setEnabled(licenseActive)
        self.addPaidAnnotation(self.controls.mirroredMode, licenseActive)
    ...
    def createUI(self,parent):
        ...
        LayerEvents.licenseStatusChanged.addHandler(self.licenseStatusChanged, parent)
