...
class MainWindow(object):
    ...
    def open():
        ...
        def openMaya2017():
            ...
            if cmds.workspaceControl(MainWindow.DOCK_NAME,q=True,exists=True):
                cmds.deleteUI(MainWindow.DOCK_NAME,control=True)
    ...
    def createUI(self,parent):
        ...
        cmds.scriptJob(runOnce=True,uiDeleted=(parent,self.uiDeleted))
        ...
        self.tabPaint = TabPaint()
        self.addTab(self.tabPaint)

        from ngSkinTools.ui.tabMirror import TabMirror
        self.tabMirror = TabMirror()
        self.addTab(self.tabMirror)
